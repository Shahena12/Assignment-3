...
func main() {
	Articles = []Article{
		Article{Id: "1", Name: "Shahena", Bio: "Trainee", Position: "Golang"},
		Article{Id: "2", Name: "Gayathri", Bio: "Unknown", Position: "Nothing"},
		Article{Id: "3", Name: "Sandy", Bio: "friend", Position: "bestie1"},
		Article{Id: "4", Name: "Hari", Bio: "friend", Position: "bestie2"},
		Article{Id: "5", Name: "mary", Bio: "friend", Position: "bestie3"},
	}
	handleRequests()
}